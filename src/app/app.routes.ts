...
export const routes: Routes = [
  ...
  //         path: 'dashboard',
  //         loadComponent: () =>
  //           import('./features/client/dashboard-client/dashboard-client.component').then(m => m.DashboardClientComponent)
  //       },
  //       {
  //         path: 'virement',
  //         loadComponent: () =>
  ...
  //         path: 'prets',
  //         loadComponent: () =>
  //           import('./features/client/prets/liste-prets/liste-prets.component').then(m => m.ListePretsComponent)
  //       },
  //       {
  //         path: 'prets/nouvelle-demande',
  //         loadComponent: () =>
  //           import('./features/client/prets/nouvelle-demande/nouvelle-demande.component').then(m => m.NouvelleDemandeComponent)
  //       },
  //       {
  //         path: 'prets/:id',
  //         loadComponent: () =>
  //           import('./features/client/prets/detail-pret/detail-pret.component').then(m => m.DetailPretComponent)
  //       },
  //       {
  //         path: 'historique',
  //         loadComponent: () =>
  //           import('./features/client/historique/historique.component').then(m => m.HistoriqueComponent)
  //       }
  //     ]
  //   },
